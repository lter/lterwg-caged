...
# NOTE ----
## Drafting this code by slowly cannibalizing the beta dispersion workflow (nested loop is needed mostly)
## Ignore anything in the 'basement' below!
