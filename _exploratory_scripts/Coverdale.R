...
setwd("/Users/Tyler_Coverdale/Dropbox (Harvard)/Documents/Project Ideas/CAGED/lterwg-caged/")

#Import current step 02 file containing all unique taxa names
taxa_list = read.csv("/Users/Tyler_Coverdale/Dropbox (Harvard)/Documents/Project Ideas/CAGED/lterwg-caged/02_caged_tidied_06May2025.csv")
